...
describe('ProductService', () => {
  ...
  it('should return relations in find all product', async () => {
    const spy = jest.spyOn(productRepository, 'find');
    const products = await service.findAllProduct([], true);
  ...
  it('should return relations and array in find all product', async () => {
    const spy = jest.spyOn(productRepository, 'find');
    const products = await service.findAllProduct([1], true);
  ...
  it('should return error if products empty', async () => {
    ...
    expect(service.findAllProduct()).rejects.toThrowError();
  });
  ...
  it('should return error in update product', () => {
